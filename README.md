...
![DatabaseSchema](./db%20schema(1).png)
...
* Request
  * Method: POST
  * URL: /groups/:groupId/create-image
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: POST
  * URL: /events/:eventId/attendance-request
  * Headers:
    * Content-Type: application/json
  * Body: none
...
* Request
  * Method: DELETE
  * URL: /groups/:groupId/groupimages/:id
  * Body: none
...
* Request
  * Method: DELETE
  * URL: /events/:eventId/eventimages/:id
  * Body: none
